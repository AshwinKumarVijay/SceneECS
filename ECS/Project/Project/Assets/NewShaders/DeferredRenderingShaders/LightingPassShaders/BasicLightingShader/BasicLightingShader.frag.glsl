...
layout (binding = 24) uniform sampler2D g_emissionColorAndIntensity;
layout (binding = 25) uniform sampler2D g_metallicnessRoughnessFresnelOpacity;
...
void main(void)
{
	...
	//	Output the Color.
	o_baseOutputColor = vec4(totalLightResult, 1.0);
}